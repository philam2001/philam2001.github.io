...
export const NavBar = () => {
    ...
    const calculateDynamicSpacing = () => {
        ...
        const dynamicGap = screenWidth > 1400 ? 340 : Math.max(3, 340 - (1400 - screenWidth) * 0.9);
        setGapBetweenLinksAndIcons(dynamicGap);

        if (screenWidth < 1100 && screenWidth > 700) {
            setNavbarSpacing(Math.max(8, 20 - (1100 - screenWidth) / 10));
